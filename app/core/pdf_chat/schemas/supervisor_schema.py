...
class RouteQuery(BaseModel):
    ...
    datasource: Literal["sql_flow", "chat_flow"] = Field(
        ...,
        description="Dada una pregunta de usuario, decide si debe enrutarse a 'sql_flow' (para consultas de datos que requieren BigQuery) o 'chat_flow' (para saludos, preguntas generales o cualquier otra cosa que no sea una consulta de datos específica).",
    )
